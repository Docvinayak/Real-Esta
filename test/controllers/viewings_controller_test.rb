...
class ViewingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create viewing" do
    assert_difference("Viewing.count") do
      post viewings_url, params: { viewing: { date: @viewing.date, property_id: @viewing.property_id, user_id: @viewing.user_id } }
    end
  ...
  test "should update viewing" do
    patch viewing_url(@viewing), params: { viewing: { date: @viewing.date, property_id: @viewing.property_id, user_id: @viewing.user_id } }
